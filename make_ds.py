...
i2.path = os.path.join(root, "instances", "NotoSerifTagalog-SemiBold.ufo")
...
i3.styleName = "Bold"
i3.path = os.path.join(root, "instances", "NotoSerifTagalog-Bold.ufo")
...
path = os.path.join(root, "NotoSerifTagalog.designspace")
doc.write(path)
